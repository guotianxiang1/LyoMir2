...
namespace GameSvr
{
    ...
    public class LuckPointCommand : BaseCommond
    {
        ...
        public void LuckPoint(string[] @Params, TPlayObject PlayObject)
        {
            ...
            if (sCtr == "")
            {
                PlayObject.SysMsg(string.Format(M2Share.g_sGameCommandLuckPointMsg, sHumanName, PlayObject.m_nBodyLuckLevel, PlayObject.m_nBodyLuckLevel, PlayObject.m_nLuck), MsgColor.Green, MsgType.Hint);
                return;
            }
