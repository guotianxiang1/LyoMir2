...
namespace GameSvr
{
    public class GoodItem
    {
        ...
        public ushort NativeWireIndex = 0;
        public ushort NativeReserved02 = 0;
        public string Name;
        public byte StdMode = 0;
        public byte Shape = 0;
        public ushort Weight = 0;
        public ushort AniCount = 0;
        public short Source = 0;
        public int Outlook = 0;
        ...
        public int Price = 0;
        public byte AntiqueLevel = 0;
        public ushort ItemScore = 0;
        public ushort SuitEquipType = 0;
        public ushort BaseEffectId = 0;
        public ushort WordParam1 = 0;
        public ushort WordParam2 = 0;
        public int IntParam1 = 0;
        public int IntParam2 = 0;
        public int IntParam3 = 0;
        public ushort MaxSteelLevel = 0;
        public ushort MaxVeinsLevel = 0;
        public ushort OutLookWord = 0;
        public byte NeedJob = 0;
        public int ItemLevel = 0;
        public ushort ItemConf = 0;
        public bool NativeItemExtAbilParsed = true;
        public ushort[] NativeItemExtAbilIdents = new ushort[6];
        public ushort[] NativeItemExtAbilValues = new ushort[6];
        public ushort NativeDrugHealthBonus = 0;
        public ushort NativeDrugSpellBonus = 0;
        public ushort NativeDrugJobBonus = 0;
        public byte[] NativeStdItemWireBody;
        ...
        public void GetStandardItem(ref TStdItem stdItem)
        {
            ...
            stdItem.Shape = Shape;
            stdItem.Weight = unchecked((byte)Weight);
            stdItem.AniCount = unchecked((byte)AniCount);
            stdItem.reserved = unchecked((byte)Reserved);
            ...
            switch (ItemType)
            {
                case GoodType.ITEM_WEAPON:
                    ...
                    if (M2Share.RandomNumber.Random(3) < 2)
                    {
                        ...
                        userItem.DuraMax = (ushort)HUtil32._MIN(65000, userItem.DuraMax + nVal);
                        userItem.Dura = (ushort)HUtil32._MIN(65000, userItem.Dura + nVal);
                    }
                    nUpgrade = GetRandomRange(12, 15);
